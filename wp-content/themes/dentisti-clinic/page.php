...
<?php do_action( 'dentisti_clinic_page_header' ); ?>

<main role="main" id="maincontent" class="middle-align">
    <div class="container">
        <?php
        $dentisti_clinic_left_right = get_theme_mod( 'dentisti_clinic_single_page_sidebar_layout','One Column');
...
<?php do_action( 'dentisti_clinic_page_footer' ); ?>
