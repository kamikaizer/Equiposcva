        ...
        <div class="container">
            ...
            if($dentisti_clinic_left_right == 'Left Sidebar'){ ?>
                <div class="row">
                    ...
                    <div id="post-<?php the_ID(); ?>" <?php post_class('col-lg-8 col-md-8 noresult-content'); ?>>
                       <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','dentisti-clinic'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
            ...
            <?php }else if($dentisti_clinic_left_right == 'One Column'){ ?>
                <div id="post-<?php the_ID(); ?>" <?php post_class('noresult-content'); ?>>
                   <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','dentisti-clinic'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
            ...
            <?php }else if($dentisti_clinic_left_right == 'Grid Layout'){ ?>
                <div class="row">
                    <div id="post-<?php the_ID(); ?>" <?php post_class('col-lg-9 col-md-9 row noresult-content'); ?>>
                       <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','dentisti-clinic'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
