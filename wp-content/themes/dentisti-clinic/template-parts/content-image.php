...
<article class="page-box">
  <?php if( get_theme_mod( 'dentisti_clinic_show_featured_image_post',true) != '') { ?>
    <div class="box-img">
  ...
  <div class="new-text">
    ...
    <?php }?>
    <?php if(get_theme_mod('dentisti_clinic_blog_post_description_option') == 'Full Content'){ ?>
      <div class="entry-content"><p><?php the_content();?></p></div>
    <?php }
    if(get_theme_mod('dentisti_clinic_blog_post_description_option', 'Excerpt Content') == 'Excerpt Content'){ ?>
      <?php if(get_the_excerpt()) { ?>
        <div class="entry-content"><p><?php $excerpt = get_the_excerpt(); echo esc_html( dentisti_clinic_string_limit_words( $excerpt, esc_attr(get_theme_mod('dentisti_clinic_excerpt_number','20')))); ?> <?php echo esc_html( get_theme_mod('dentisti_clinic_post_suffix_option','...') ); ?></p></div>
      <?php }?>
    <?php }?>
